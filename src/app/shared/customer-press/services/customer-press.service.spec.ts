...
import { CustomerPressService } from './customer-press.service';

describe('CustomerPressService', () => { 
  beforeEach(() => {
  ...
  it('should ...', inject([CustomerPressService], (service: CustomerPressService) => {
